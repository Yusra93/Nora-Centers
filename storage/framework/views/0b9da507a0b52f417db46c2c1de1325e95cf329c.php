...
<!-- Select Basic -->
        ...
        <!-- start form -->
        <form action="<?php echo e(url ('course')); ?>" method="POST" enctype="multipart/form-data" class="form-horizontal">
        <fieldset>
        <?php echo csrf_field(); ?>
        ...
        <div class="form-group">
            <label class="col-md-4 control-label " for="course_cost">إسم الكورس</label>
            <div class="col-md-2">
            <input class="form-control input-md-4" disabled="disabled" id="course" name="course" value=" <?php echo e(App\CourseName::find($id)->course_name); ?>">
             </div>
        </div> 

        <div class="form-group">
          <label class="col-md-4 control-label" for="teacher_id">إسم الأستاذ</label>
          <div class="col-md-4">
        ...
        <!-- input course name-->
        <div class="form-group">
          <label class="col-md-4 control-label" for="course_cost">السعر</label>
          <div class="col-md-4">
        ...
        <div class="form-group">
          <label class="col-md-4 control-label" for="course_room">الغرفة</label>
          <div class="col-md-4">
         ...
         <!-- input course name-->
        <div class="form-group">
          <label class="col-md-4 control-label" for="course_begin">البداية</label>
          <div class="col-md-2">
        ...
        <!-- input course description-->
        <div class="form-group">
          <label class="col-md-4 control-label" for="course_end">النهاية</label>
          <div class="col-md-2">
    ...
    <TR>
      ...
      <TD class="col-md-2">
        <div class="boddy " >
             ...
             <input type="text" name="subject[]" value="subject" placeholder="subject" class="subject form-control">
