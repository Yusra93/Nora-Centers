...
<!--overview start-->
<i class="fa fa-caret-square-o-left"></i><a href="{{ url ('course/'.$course->id) }}" > Back </a>
    <!--overview end -->
 	{{ Form::model($course, array('route' => array('course.update', $course->id), 'method' => 'PUT','class' => 'form-horizontal')) }}
	...
	<fieldset>
        ...
        <div class="form-group">
            ...
            <input hidden="hidden" id="course_id" name="course_id" value=" {{App\Course::find($id)->courses_names_id}}">
        </div> 
        ...
        <div class="form-group">
          ...
          <div class="col-md-4">
          {{ Form::text('course_cost', null, array('class' => 'form-control input-md')) }}
          </div>
        </div>
        <div class="form-group">
        <!-- <div class="boddy " >
        ...
        <div class="form-group">
          ...
          <div class="col-md-4">
          {{ Form::text('course_room', null, array('class' => 'form-control input-md')) }}
          </div>
        </div>
