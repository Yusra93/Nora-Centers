        ...
        <div class="container">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="/">
                    <img height="50px" width="50px" style="border-radius:50%;" src="<?php echo e(asset('icon.png')); ?>" alt="LOGO">
                </a>
            </div>
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                ...
                <form class="form-inline " action="<?php echo e(url ('/student/search')); ?>" method="POST" enctype="multipart/form-data" style="padding-top: 10px">
                    ...
                    <div class="form-group">
                        <input list="student_list" placeholder="Search Student" name="student" class="form-control input-md">
